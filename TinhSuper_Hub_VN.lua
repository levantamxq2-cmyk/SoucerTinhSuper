...
Ecto = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự Động Farm Vật Chất Kỳ Dị",
	["Default"] = false,
	["Callback"] = function(state)
...
ChestBP = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Nhặt Rương TP";
	["Description"] = "Dễ Ăn Band 1 ngày - 1 tuần",
	["Default"] = false;
...
spawn(function()
	...
	while wait(1) do
		...
		if L_426_[3] ~= L_425_[2] then
			EliteHunter:SetDesc("Trạng Thái: " .. (L_426_[3] .. (" | Đã Giết: " .. L_426_[1])))
			L_425_[2] = L_426_[3]
		end
	end
end)
...
Cake = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({"Tự Động Cày Hoàng Tử Bộ","t"}),
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(v)
...
CakeSM = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({"Tự Động Triệu Hồi Hoàng Tử ","Bột"}),
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(v)
		_G.AutoSpawnCP = v
...
spawn(function()
	while task.wait(0.5) do
		pcall(function()
			CheckingBone:SetDesc(" Xương hiện có : "..tostring(
